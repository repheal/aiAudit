define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'task/taskmy/index' + location.search,
                    add_url: 'task/taskmy/add',
                    edit_url: 'task/taskmy/edit',
                    del_url: 'task/taskmy/del',
                    multi_url: 'task/taskmy/multi',
                    import_url: 'task/taskmy/import',
                    table: 'data',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'task/taskmy/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
