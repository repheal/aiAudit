...
return [
    ...
    'aliyun' =>  array(
	    'accessKeyId' 		=>	"LTAI4FiuJ3SmAruqSMxn5r2x",//ak
	    'accessKeySecret' 	=> 	"A7GlQagVaoQFw93u1eCOCBMjxb4JWE",//sk
	    'endpoint'			=>	"http://oss-cn-shanghai.aliyuncs.com",//地域节点
	    'bucket'			=>	"repheal",//存储空间
	    'greenPoint'		=> 'green.cn-shanghai.aliyuncs.com',
    ),
];
